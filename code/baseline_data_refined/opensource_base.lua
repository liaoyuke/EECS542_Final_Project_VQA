...
function load_visualqadataset(opt, dataType, manager_vocab)
    ...
    local filename_question = paths.concat(path_dataset, prefix .. '_question_refined.txt')
    local filename_answer = paths.concat(path_dataset, prefix .. '_answer_refined.txt')
    local filename_imglist = paths.concat(path_dataset, prefix .. '_imglist_refined.txt')
