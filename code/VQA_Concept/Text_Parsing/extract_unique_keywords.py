...
input_files.append("questions/coco_trainval2014_train_question_keywords_stem.txt")
input_files.append("questions/coco_trainval2014_val_question_keywords_stem.txt")
